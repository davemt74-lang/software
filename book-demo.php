...
$labels=['agent'=>'AI Agent + cognitive workflow','browser'=>'Browser Companion + Annotations','meetings'=>'Meetings + Transcription + AI Summary','teams'=>'Teams + collaboration','booking'=>'Calendar + Booking','commerce'=>'Ecommerce + Agent Analytics','profile'=>'Personal URL + Profile Agent','homeserver'=>'HomeServer + private AI'];
...
vp3_public_header('Book a Demo — VP3','See one VP3 Agent connect browser research, meetings, teams, scheduling, commerce, analytics, Profile Agent, and HomeServer.');
?>
<section class="vp3-public-hero"><div class="vp3-kicker">See the connected VP3 workflow</div><h1>Build one Agent around how you actually work.</h1><p>Choose the surfaces you care about and we’ll focus the demo on how VP3 connects them from capture through outcomes and follow-through.</p></section>
<main id="main-content"><section class="vp3-section"><div class="vp3-wrap vp3-demo-grid">
  <aside class="vp3-card vp3-demo-aside"><div><div class="vp3-kicker">Capture → Understand → Coordinate → Sell → Measure</div><h2>One Agent across the full workflow.</h2><p>See Browser Companion, meetings, Profile Agent, Teams, scheduling, commerce, analytics, and HomeServer cooperate through the same approved context and cognitive runtime.</p><div class="vp3-about-points"><div class="vp3-about-point"><b>Capture + understand</b><span>Browser research, annotations, meetings, transcription, summaries, and reusable knowledge.</span></div><div class="vp3-about-point"><b>Coordinate + transact</b><span>Teams, calendar, booking, products, checkout, and customer lifecycle.</span></div><div class="vp3-about-point"><b>Measure + follow through</b><span>Conversion intelligence, opportunities, reminders, workflows, and Agent next actions.</span></div></div></div></aside>
  <div class="vp3-card"><div class="vp3-kicker">Request a demo</div><h2 id="demo-form-heading">What should we show you?</h2><p>Answer a few questions and we’ll tailor the conversation.</p>
    ...
    <form method="post" action="<?=e(url('/book-demo.php'))?>" aria-labelledby="demo-form-heading"><?=csrf_field()?><?php foreach(['plan','billing','origin','source','return_to'] as $intentKey):if(isset($funnelIntent[$intentKey])):?><input type="hidden" name="<?=e($intentKey)?>" value="<?=e((string)$funnelIntent[$intentKey])?>"><?php endif;endforeach;?><div style="position:absolute;left:-9999px" aria-hidden="true"><label for="website">Website</label><input id="website" name="website" tabindex="-1" autocomplete="off"></div>
