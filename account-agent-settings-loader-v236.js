(() => {
  ...
  const computeBuild='agent-compute-v023-20260908-agent-compute-v024-20260908-agent-compute-v026-scope-20260908-agent-compute-v027-acceptance-20260908';
  const assets=[
    ...
    ['link','data-homeserver-acceptance-v027-css',new URL(`./homeserver-acceptance-v027.css?v=${computeBuild}`,window.location.href).href,computeBuild],
    ...
    ['script','data-homeserver-acceptance-v027-js',new URL(`./account-homeserver-acceptance-v027.js?v=${computeBuild}`,window.location.href).href,computeBuild],
  ];
