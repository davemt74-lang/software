...
try{
    ...
    if($status==='paid'){$notice=['kind'=>'verified','headline'=>'Payment verified.','message'=>'Your payment is confirmed in the canonical Commerce order.'];profile_commerce_checkout_intent_forget_v900($nonce);}
    elseif($status==='partially_paid'){$notice=['kind'=>'verified','headline'=>'Deposit verified.','message'=>'Your deposit is confirmed in the canonical Commerce order.'];profile_commerce_checkout_intent_forget_v900($nonce);}
