...
<section class="card half"><div class="muted">Agent authority</div><div class="metric">Read + notify</div><p class="muted">Tracky V2.72 can read governed physical context and publish attention/trigger metadata. It still has no device-control or autonomous physical-action authority.</p></section>
