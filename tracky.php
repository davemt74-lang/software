...
$reliabilityState=function_exists('tracky_v274_reliability_state')
    ?tracky_v274_reliability_state($pdo,$user,$selected)
    :['state'=>'unavailable','reason'=>'v2.74_unavailable','fresh_verification'=>false];
...
<section class="card half"><div class="muted">End-to-end reliability · V2.74</div><div class="metric"><?= e(ucfirst((string)($reliabilityState['state']??'unknown'))) ?></div><p class="muted"><?= e(str_replace('_',' ',(string)($reliabilityState['reason']??'unknown'))) ?> · fresh verification <?= !empty($reliabilityState['fresh_verification'])?'available':'blocked' ?>.</p></section>
