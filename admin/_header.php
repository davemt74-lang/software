    ...
    <nav class="admin-navigation admin-accordion-navigation" aria-label="Admin navigation">
      ...
      <section class="admin-nav-group admin-nav-group-music" data-admin-nav-group="music" data-admin-nav-default="closed">
        ...
        <div class="admin-nav-group-links" id="admin-nav-music" hidden>
          ...
          <?php if (has_permission('listening.view')): ?><a class="<?= $adminActive === 'listening' ? 'active' : '' ?>" href="<?= e(url('/admin/listening.php')) ?>"><span>Listening Analytics</span></a><a class="<?= $adminActive === 'analytics' ? 'active' : '' ?>" href="<?= e(url('/admin/analytics.php')) ?>"><span>Music Analytics</span></a><?php endif; ?>
        </div>
      </section>
    </nav>
