...
<?php if($userId>0): ?>
<form method="post"><input type="hidden" name="csrf" value="<?=annotation_page_e_v2050(csrf_token())?>"><input type="hidden" name="id" value="<?=annotation_page_e_v2050($publicId)?>"><input type="hidden" name="action" value="save"><input type="hidden" name="enabled" value="<?=!empty($item['interactions']['saved'])?'0':'1'?>"><button><?=!empty($item['interactions']['saved'])?'Unsave':'Save'?></button></form>
<form method="post"><input type="hidden" name="csrf" value="<?=annotation_page_e_v2050(csrf_token())?>"><input type="hidden" name="id" value="<?=annotation_page_e_v2050($publicId)?>"><input type="hidden" name="action" value="research"><input type="hidden" name="enabled" value="<?=!empty($item['interactions']['in_research'])?'0':'1'?>"><button><?=!empty($item['interactions']['in_research'])?'Remove from Research':'Add to Research'?></button></form>
...
<?php if($userId>0): ?><form class="compose" method="post"><input type="hidden" name="csrf" value="<?=annotation_page_e_v2050(csrf_token())?>"><input type="hidden" name="id" value="<?=annotation_page_e_v2050($publicId)?>"><input type="hidden" name="action" value="comment"><input name="body" maxlength="4000" required placeholder="Add a comment…"><button>Comment</button></form><?php endif; ?>
</section></article>
