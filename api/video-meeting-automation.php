...
try{
    ...
    $prep['continuity']=video_meeting_continuity_schema_ready_v18210($pdo)?video_meeting_continuity_guarded_state_v18210($pdo,$meeting,$userId):['version'=>'v18.21','schema'=>'vp3.meeting.continuity','candidates'=>[],'not_ready'=>true];
