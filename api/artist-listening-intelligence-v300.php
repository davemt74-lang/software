...
const VP3_TRANSCRIPTION_INTELLIGENCE_V300 = 'vp3-transcription-intelligence-v302-20260906';
...
try {
    ...
    if ($action === 'save_brain') {
        ...
        $id = agent_brain_v122_upsert_system_memory(
            ...
            ['source'=>'transcription-intelligence-v302','session_id'=>$sessionId,'title'=>(string)($session['title']??''),'tags'=>$tags,'source_hash'=>(string)$map['source_hash'],'saved_at'=>gmdate('c')],0.98
        );
