...
function chat_notifications_v240_state(array $user, PDO $pdo, int $agentId=0): array
{
    ...
    $followthrough = $brainAllowed && function_exists('vp3_cognitive_followthrough_activity_projection_v2450')
        ? vp3_cognitive_followthrough_activity_projection_v2450($pdo, $user, $namespace)
        : ['build'=>'','focus'=>null,'items'=>[],'counts'=>[],'projection_only'=>true];
    $supervision = $brainAllowed && function_exists('vp3_cognitive_supervision_activity_projection_v2460')
        ? vp3_cognitive_supervision_activity_projection_v2460($pdo, $user, $namespace)
        : ['build'=>'','focus'=>null,'issues'=>[],'counts'=>[],'projection_only'=>true];
    $autonomy = $brainAllowed && function_exists('vp3_cognitive_autonomy_activity_projection_v2470')
        ? vp3_cognitive_autonomy_activity_projection_v2470($pdo, $user, $namespace)
        : ['build'=>'','focus'=>null,'items'=>[],'counts'=>[],'projection_only'=>true];
    $portfolio = $brainAllowed && function_exists('vp3_cognitive_portfolio_activity_projection_v2480')
        ? vp3_cognitive_portfolio_activity_projection_v2480($pdo, $user, $namespace)
        : ['build'=>'','focus'=>null,'items'=>[],'counts'=>[],'capacity'=>[],'projection_only'=>true];
    $forecast = $brainAllowed && function_exists('vp3_cognitive_forecast_activity_projection_v2490')
        ? vp3_cognitive_forecast_activity_projection_v2490($pdo, $user, $namespace)
        : ['build'=>'','focus'=>null,'items'=>[],'counts'=>[],'conflicts'=>[],'projection_only'=>true];
    $optimization = $brainAllowed && function_exists('vp3_cognitive_optimization_activity_projection_v2510')
        ? vp3_cognitive_optimization_activity_projection_v2510($pdo, $user, $namespace)
        : ['build'=>'','recommended_strategy'=>'','focus'=>null,'items'=>[],'scenarios'=>[],'counts'=>[],'projection_only'=>true];
    ...
    $commitmentProtection = $brainAllowed && function_exists('vp3_cognitive_commitment_activity_projection_v2540')
        ? vp3_cognitive_commitment_activity_projection_v2540($pdo, $user, $namespace)
        : ['build'=>'','focus'=>null,'commitments'=>[],'counts'=>[],'projection_only'=>true];
    $economics = $brainAllowed && function_exists('vp3_cognitive_economics_activity_projection_v2550')
        ? vp3_cognitive_economics_activity_projection_v2550($pdo, $user, $namespace)
        : ['build'=>'','focus'=>null,'goals'=>[],'usage'=>[],'quota'=>[],'counts'=>[],'projection_only'=>true];
    $budgetGovernance = $brainAllowed && function_exists('vp3_cognitive_budget_activity_projection_v2560')
        ? vp3_cognitive_budget_activity_projection_v2560($pdo, $user, $namespace)
        : ['build'=>'','configured'=>false,'focus'=>null,'policies'=>[],'held_goals'=>[],'counts'=>[],'manage_url'=>'','projection_only'=>false];
    ...
    $currentState = $brainAllowed && function_exists('vp3_cognitive_current_state_projection_v2590')
