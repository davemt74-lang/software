...
<?php foreach($sourceChanges as $change): ?><article class="trust-card"><strong>Source changed</strong><div><?=source_page_e_v2050((string)$change['summary'])?></div><div class="trust-meta"><?=source_page_e_v2050((string)$change['observed_at'])?><?php if(!empty($change['from']['hash_short'])&&!empty($change['to']['hash_short'])): ?> · <?=source_page_e_v2050((string)$change['from']['hash_short'])?> → <?=source_page_e_v2050((string)$change['to']['hash_short'])?><?php endif; ?></div></article><?php endforeach; ?>
