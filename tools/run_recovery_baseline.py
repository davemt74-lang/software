...
NODE_TESTS = [
    ...
    'tests/transcription-deeper-intelligence.mjs',
    'tests/transcription-provenance-step4.mjs',
    ...
    'tests/cognitive-followthrough-v2450.mjs',
    ...
    'tests/tracky-v270-cloud-contract.mjs',
    'tests/tracky-v271-agent-brain-contract.mjs',
    'tests/tracky-v272-cross-surface-contract.mjs',
    'tests/tracky-v273-contract-join-contract.mjs',
    'tests/tracky-v274-reliability-contract.mjs',
    'tests/cognitive-entity-graph-v2610.mjs',
    'tests/campaigns-rewards-v100.mjs',
    'tests/campaigns-rewards-v110.mjs',
    'tests/campaigns-rewards-v118.mjs',
    'tests/campaigns-rewards-v119.mjs',
    'tests/campaigns-rewards-v120.mjs',
    ...
    'tests/campaigns-rewards-v125.mjs',
    ...
    'tests/subscription-access-contract.mjs',
    ...
    'tests/agent-radar-foundation-contract.mjs',
    'tests/agent-radar-native-profile-contract.mjs',
    'tests/agent-radar-interface-contract.mjs',
    ...
    'tests/crm-intelligence-learned-outcomes-contract.mjs',
    ...
    'tests/transcription-folder-observer-hotfix-contract.mjs',
...
PHP_TESTS = [
    ...
    'tests/tracky-v273-contract-join-unit.php',
    'tests/tracky-v274-reliability-unit.php',
    ...
    'tests/campaigns-rewards-v110.php',
    'tests/campaigns-rewards-v118.php',
    'tests/campaigns-rewards-v119.php',
    'tests/campaigns-rewards-v120.php',
    ...
    'tests/campaigns-rewards-v125.php',
]
