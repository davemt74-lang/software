...
function trackingSnippet(site){
  ...
  return `<script async src="${analytics}" data-vp3-key="${key}"></script>\n<script async src="${radar}" data-vp3-key="${key}"></script>`;
}
