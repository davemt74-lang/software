...
must(manifest.version==='21.2.0','v21.20 manifest version missing');
must(background.includes("const VP3_EXTENSION_VERSION = '21.2.0';"),'v21.20 request version missing');
