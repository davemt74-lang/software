...
const checks=[
 ...
 ['HomeServer datasets participate in central Agent data policy',/homeserver_memory/.test(catalog)&&/homeserver_knowledge/.test(catalog)&&/homeserver_contacts/.test(catalog)&&/homeserver_tasks/.test(catalog)&&/homeserver_notifications/.test(catalog)],
 ['Profile Agent uses same fabric only through existing policy gate',/homeserver_shared_v210_exchange/.test(profile)&&/user_data_policy_can_use_v236/.test(profile)&&/homeserver_memory/.test(profile)&&/homeserver_knowledge/.test(profile)&&/homeserver_contacts/.test(profile)&&/homeserver_tasks/.test(profile)&&/homeserver_notifications/.test(profile)],
