...
const checks=[
 ...
 ['lifecycle intelligence reads Decision-time canonical context and never updates CRM lifecycle',
  runtime.includes("['contact']['lifecycle_stage']")&&runtime.includes("'source'=>'decision_time_context'")&&!runtime.includes('UPDATE crm_merchant_relationships')],
