...
cr_v119_assert(in_array(($domain['implementation_status']??''),['integrated-v1.19','integrated-v1.20','integrated-v1.21'],true),'cognitive domain declares integrated V1.19');
