...
const checks=[
 ...
 ['Cognitive domain recognizes branch retry dead-letter and provider lifecycle events',registry.includes("'implementation_status'=>'integrated-v1.21'")&&registry.includes("'campaign.journey_branch_selected'")&&registry.includes("'campaign.message_dead_lettered'")&&registry.includes("'campaign.provider_event_received'")],
 ...
 ['production package advances to V1.21 and retains runtime webhook and cron',packageFlow.includes('"Campaigns & Rewards V1.21"')&&packageFlow.includes('campaigns-rewards-v121.php')&&packageFlow.includes('campaign-delivery-webhook-v121.php')&&packageFlow.includes('cron/campaigns-rewards-v121.php')],
