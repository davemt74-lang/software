...
const [researchMajor,researchMinor]=manifest.version.split('.').map(Number);
must(researchMajor>20||(researchMajor===20&&researchMinor>=60),'Phase 7 requires Browser Companion v20.60 or newer');
