...
const browserNow = read('api/extension-cognitive-now-v2120.php');
...
const checks = [
  ...
  ['client projection is summary-only', /function vp3_cognitive_operations_public_v2300/.test(operations) && !/['\"]items['\"]\s*=>/.test(operations.split('function vp3_cognitive_operations_public_v2300')[1].split('function vp3_cognitive_operations_compose_v2300')[0])],
  ...
  ['browser Now carries same summary', /'operations'=>is_array\(\$feed\['operations'\]/.test(browserNow)],
