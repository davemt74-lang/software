...
const publicPage=[read('public-booking.php'),read('public-booking-controller-v700.php'),read('public-booking-view-v700.php')].join('\n');
const teamPage=[read('team-book.php'),read('includes/team-book-controller-v700.php'),read('includes/team-book-view-v700.php')].join('\n');
const memberPage=[read('appointment-lifecycle.php'),read('includes/appointment-lifecycle-controller-v700.php'),read('includes/appointment-lifecycle-view-v700.php')].join('\n');
