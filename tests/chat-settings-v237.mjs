...
assert.match(settingsCss, /#chatSidebar\{padding-bottom:66px!important\}/);
assert.match(settingsCss, /\.chat-settings-launcher\{[\s\S]*position:absolute;[\s\S]*bottom:10px;/);
...
assert.match(chatPhp, /\$chatSettingsBuild = 'chat-settings-v239-canonical-20260905'/);
