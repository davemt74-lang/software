...
assert.ok(collectApi.includes('vp3_radar_server_collect'), 'server collector must use canonical server Radar runtime');
...
assert.ok(sitesUi.includes("'status_code' => http_response_code()"), 'PHP integration must send final response status');
