...
const checks=[
 ...
 ['manual Campaign dispatch preserves V1.24 instance controls and V1.22 deferral metrics',(campaigns.includes('campaigns_rewards_dispatch_due_v125')||campaigns.includes('campaigns_rewards_dispatch_due_v126'))&&runtime.includes('campaigns_rewards_dispatch_due_v124')&&v124.includes("'frequency_deferred'=>0")&&v124.includes("'optimized_deferred'=>0")],
 ...
 ['cognitive registry advances to V1.25 Decision authority',(registry.includes("'implementation_status'=>'integrated-v1.25'")||registry.includes("'implementation_status'=>'integrated-v1.26'"))&&registry.includes("'campaign_decisions'")&&registry.includes("'campaign.decision_recorded'")],
 ...
 ['Campaign workspace requires V1.25 migration and exposes node decisioning preview and ledger',campaigns.includes('Adaptive Campaign Optimization V1.26')&&campaigns.includes('V1.25 personalization & decisioning')&&campaigns.includes('Personalization & Offer Decisions')&&campaigns.includes('Recent decision ledger')],
 ...
 ['production package identifies V1.25 and includes schema runtime release migration cron and docs',(packageFlow.includes('"Campaigns & Rewards V1.25"')||packageFlow.includes('"Campaigns & Rewards V1.26"'))&&packageFlow.includes('campaigns-rewards-schema-v125.php')&&packageFlow.includes('campaigns-rewards-v125.php')&&packageFlow.includes('upgrade-campaigns-rewards-v125.sql')&&packageFlow.includes('cron/campaigns-rewards-v125.php')],
