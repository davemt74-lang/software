...
const checks=[
 ...
 ['production package retains V1.25 schema runtime release migration and cron under the global VP3 release label',packageFlow.includes('"VP3 Cloud Production"')&&packageFlow.includes('campaigns-rewards-schema-v125.php')&&packageFlow.includes('campaigns-rewards-v125.php')&&packageFlow.includes('upgrade-campaigns-rewards-v125.sql')&&packageFlow.includes('cron/campaigns-rewards-v125.php')],
