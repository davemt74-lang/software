...
cr_v121_assert(in_array(($domain['implementation_status']??''),['integrated-v1.21','integrated-v1.22','integrated-v1.23','integrated-v1.24','integrated-v1.25'],true),'cognitive domain declares integrated V1.21');
