...
const checks=[
 ['shared Cloud/HomeServer product release version is v2.2',
  vp3.includes("const VP3_HOMESERVER_RELEASE_VERSION = '2.2';")&&
...
console.log('VP3 Cloud / HomeServer v2.2 HTTPS relay contract: '+checks.length+'/'+checks.length+' passed');
