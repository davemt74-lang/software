...
const checks=[
 ...
 ['Cognitive domain advances to V1.22 optimization lifecycle',(registry.includes("'implementation_status'=>'integrated-v1.22'")||(registry.includes("'implementation_status'=>'integrated-v1.23'")||(registry.includes("'implementation_status'=>'integrated-v1.24'")||(registry.includes("'implementation_status'=>'integrated-v1.25'")||registry.includes("'implementation_status'=>'integrated-v1.26'")))))&&registry.includes("'campaign.journey_send_time_optimized'")&&registry.includes("'campaign.journey_recommendation_reviewed'")],
