...
const checks=[
 ...
 ['Cognitive domain advances to V1.22 optimization lifecycle',(registry.includes("'implementation_status'=>'integrated-v1.22'")||(registry.includes("'implementation_status'=>'integrated-v1.23'")||registry.includes("'implementation_status'=>'integrated-v1.24'")))&&registry.includes("'campaign.journey_send_time_optimized'")&&registry.includes("'campaign.journey_recommendation_reviewed'")],
 ...
 ['production package advances to V1.22 and includes runtime release and cron',(packageFlow.includes('"Campaigns & Rewards V1.22"')||(packageFlow.includes('"Campaigns & Rewards V1.23"')||packageFlow.includes('"Campaigns & Rewards V1.24"')))&&packageFlow.includes('campaigns-rewards-v122.php')&&packageFlow.includes('cron/campaigns-rewards-v122.php')],
