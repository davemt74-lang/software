...
cr_v110_assert(in_array(($domain['implementation_status']??''),['integrated-v1.10','integrated-v1.18','integrated-v1.19','integrated-v1.20','integrated-v1.21'],true),'cognitive domain is at least integrated V1.10');
