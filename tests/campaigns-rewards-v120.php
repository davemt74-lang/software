...
cr_v120_assert(in_array(($domain['implementation_status']??''),['integrated-v1.20','integrated-v1.21','integrated-v1.22'],true),'cognitive domain declares integrated V1.20');
