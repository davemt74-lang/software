...
cr_v120_assert(in_array(($domain['implementation_status']??''),['integrated-v1.20','integrated-v1.21','integrated-v1.22','integrated-v1.23','integrated-v1.24'],true),'cognitive domain declares integrated V1.20');
