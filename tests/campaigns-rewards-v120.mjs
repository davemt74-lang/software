...
const checks=[
 ...
 ['Cognitive domain recognizes V1.20 messaging lifecycle',
  (registry.includes("'implementation_status'=>'integrated-v1.20'")||(registry.includes("'implementation_status'=>'integrated-v1.21'")||(registry.includes("'implementation_status'=>'integrated-v1.22'")||(registry.includes("'implementation_status'=>'integrated-v1.23'")||(registry.includes("'implementation_status'=>'integrated-v1.24'")||(registry.includes("'implementation_status'=>'integrated-v1.25'")||registry.includes("'implementation_status'=>'integrated-v1.26'")))))))&&registry.includes("'campaign.message_sent'")&&registry.includes("'campaign.message_converted'")],
 ...
 ['Production package retains V1.20 runtime/release/cron without owning the global VP3 release label',
  packageFlow.includes('"VP3 Cloud Production"')&&
  packageFlow.includes('campaigns-rewards-v120.php')&&
  packageFlow.includes('campaigns-rewards-release-v120.php')&&
  packageFlow.includes('cron/campaigns-rewards-v120.php')],
