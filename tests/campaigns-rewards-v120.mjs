...
const checks=[
 ...
 ['Cognitive domain recognizes V1.20 messaging lifecycle',
  (registry.includes("'implementation_status'=>'integrated-v1.20'")||registry.includes("'implementation_status'=>'integrated-v1.21'"))&&registry.includes("'campaign.message_sent'")&&registry.includes("'campaign.message_converted'")],
 ...
 ['Production package identifies V1.20 and includes runtime/release/cron',
  packageFlow.includes('"Campaigns & Rewards V1.20"')&&packageFlow.includes('campaigns-rewards-v120.php')&&packageFlow.includes('cron/campaigns-rewards-v120.php')],
