...
const checks=[
 ...
 ['orchestration handoff rechecks live capability', /Cognitive plan capability is unavailable/.test(orchestration) && /Cognitive plan approval boundary changed/.test(orchestration)],
