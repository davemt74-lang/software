...
assert.match(page,/artist-listening-ai\.js\?v=transcription-workflow-v304-20260906/);
assert.doesNotMatch(page,/artist-listening-ai\.js\?v=transcription-app-registry-v300-20260906|artist-listening-ai\.js\?v=c18c3dc8|&b=1d511bb5/);
...
/* AI workflow remains separate from transcript view ownership. */
...
assert.match(ai,/Live ON/);
assert.match(ai,/Live OFF/);
