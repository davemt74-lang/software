...
assert.match(page,/artist-listening-ai\.js\?v=transcription-app-registry-v300-20260906/);
assert.doesNotMatch(page,/artist-listening-ai\.js\?v=c18c3dc8|&b=1d511bb5/);
