...
$scopes=vp3_connected_site_scopes_v100($app,'account.identity.read meetings.transcripts.read fake.scope');ok($scopes===['account.identity.read','meetings.transcripts.read'],'requested scopes are intersected with registered scopes.');
