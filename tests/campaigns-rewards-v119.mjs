...
const checks=[
 ...
 ['V1.19 cognitive domain declares automation execution and recommendation events',(registry.includes("'phase'=>'campaigns-rewards-v1.19'")||registry.includes("'phase'=>'campaigns-rewards-v1.20'"))&&(registry.includes("'implementation_status'=>'integrated-v1.19'")||registry.includes("'implementation_status'=>'integrated-v1.20'"))&&registry.includes("'campaign.automation_executed'")&&registry.includes("'campaign.recommendation_proposed'")],
