...
const checks=[
 ...
 ['V1.19 cognitive domain declares automation execution and recommendation events',(registry.includes("'phase'=>'campaigns-rewards-v1.19'")||(registry.includes("'phase'=>'campaigns-rewards-v1.20'")||(registry.includes("'phase'=>'campaigns-rewards-v1.21'")||(registry.includes("'phase'=>'campaigns-rewards-v1.22'")||(registry.includes("'phase'=>'campaigns-rewards-v1.23'")||(registry.includes("'phase'=>'campaigns-rewards-v1.24'")||registry.includes("'phase'=>'campaigns-rewards-v1.25'")))))))&&(registry.includes("'implementation_status'=>'integrated-v1.19'")||(registry.includes("'implementation_status'=>'integrated-v1.20'")||(registry.includes("'implementation_status'=>'integrated-v1.21'")||(registry.includes("'implementation_status'=>'integrated-v1.22'")||(registry.includes("'implementation_status'=>'integrated-v1.23'")||(registry.includes("'implementation_status'=>'integrated-v1.24'")||registry.includes("'implementation_status'=>'integrated-v1.25','integrated-v1.26'")))))))&&registry.includes("'campaign.automation_executed'")&&registry.includes("'campaign.recommendation_proposed'")],
