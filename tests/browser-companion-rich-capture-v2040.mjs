...
const [richMajor,richMinor]=manifest.version.split('.').map(Number);
must(richMajor>20||(richMajor===20&&richMinor>=40), 'rich capture requires Browser Companion v20.40 or newer');
