...
const checks=[
 ...
 ['v26 declares canonical Campaigns authority objects',/'implementation_status'=>'integrated-v1\.(?:18|19|20|21)'/.test(domain)&&/'reward_issuance'/.test(domain)&&/'claim_code'/.test(domain)],
