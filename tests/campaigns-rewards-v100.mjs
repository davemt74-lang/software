...
const checks=[
 ...
 ['v26 declares canonical Campaigns authority objects',/'implementation_status'=>'integrated-v1\.00'/.test(domain)&&/'reward_issuance'/.test(domain)&&/'claim_code'/.test(domain)],
 ...
 ['production package requires canonical schema runtime dashboard public page Claim Terminal and Wallet',/Campaigns & Rewards V1\.00/.test(packageWorkflow)&&/campaigns-rewards-platform-v100\.php/.test(packageWorkflow)&&/campaigns-rewards-domain-v100\.php/.test(packageWorkflow)&&/campaigns\.php/.test(packageWorkflow)&&/campaign\.php/.test(packageWorkflow)&&/campaign-claim\.php/.test(packageWorkflow)&&/rewards-wallet\.php/.test(packageWorkflow)],
