...
const checks=[
 ...
 ['Proactive Now uses same current-state projection',/vp3_cognitive_current_state_projection_v2590/.test(proactive)&&/'current_state'=>'cognitive_current_state_v2590'/.test(proactive)],
 ['Agent Brain API uses same current-state projection',/vp3_cognitive_current_state_projection_v2590/.test(brainApi)&&/'current_state'=>\$currentState/.test(brainApi)],
 ...
 ['Agent Brain UI renders compact current state',/Unified Current State/.test(brainJs)&&/current_state/.test(brainJs)],
 ['release gate preserves one-event-ledger and authority boundaries',/'second_event_ledger'=>false/.test(release)&&/'canonical_event_inbox_remains_authority'=>true/.test(release)&&/'phase19_remains_claim_lease_execution_receipt_authority'=>true/.test(release)],
