...
const checks=[
 ...
 ['Cognitive domain remains integrated beyond V1.10 and includes Reward Transfer authority',/implementation_status'=>'integrated-v1\.(?:10|18|19|20|21|22|23|24)'/.test(domain)&&domain.includes("'reward_transfers'")&&domain.includes("'reward.sent'")],
