...
const checks=[
 ...
 ['QR is generated locally without network calls',qr.includes('VP3RewardQR')&&!qr.includes('fetch(')&&!qr.includes('XMLHttpRequest')&&!qr.includes('http://')&&!qr.includes('https://')&&qr.includes('VERSION=5')&&qr.includes('DATA_CODEWORDS=108')],
