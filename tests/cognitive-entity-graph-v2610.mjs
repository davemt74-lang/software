...
const checks=[
 ...
 ['Agent Brain exposes bounded graph summary and firewall presentation only',/'entity_graph_presentation'=>\\$entityGraphPresentation/.test(brain)&&/'domain_counts'=>\\$entityGraph\\['domain_counts'\\]/.test(brain)&&!/entity_graph'=>\\$entityGraph/.test(brain)],
 ['Proactive Now exposes bounded graph summary and firewall presentation only',/'entity_graph_presentation'=>\\$entityGraphPresentation/.test(proactive)&&/entity_graph_v2610_ephemeral_projection/.test(proactive)],
