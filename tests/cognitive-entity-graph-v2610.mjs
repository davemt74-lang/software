...
const checks=[
 ...
 ['Campaigns and Rewards are separate primary sidebar Plan & Sell destinations',sidebar.includes("$mainSidebarPrimaryOrder = ['home','chat','profile_agent','messages','contacts','knowledge','transcriptions','calendar','scheduling','profile_commerce','campaigns','rewards','team'];")&&sidebar.includes("'campaigns'=>'Campaigns'")&&sidebar.includes("'rewards'=>'Rewards'")&&sidebar.includes("'campaigns'=>'Plan & Sell'")&&sidebar.includes("'rewards'=>'Plan & Sell'")],
 ['Campaigns and Rewards are intentionally duplicated in bottom sidebar user menu without Reward Wallet',sidebar.includes('Campaigns and Rewards are intentionally available in both Plan & Sell')&&sidebar.includes("array_reverse(['campaigns','rewards'])")&&!sidebar.includes('/rewards-wallet.php')],
