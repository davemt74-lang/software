...
assert.doesNotMatch(trackBoundary,/has_permission|manager|producer|supervisor/,'resource authorization does not inherit legacy professional role permissions');
