...
const checks=[
 ...
 ['Campaigns & Rewards V1.18 fulfills the reference contract',/'implementation_status'=>'integrated-v1\.18'/.test(registry)&&/'merchant_accounts'/.test(registry)&&/'reward_issuances'/.test(registry)&&/'reward_claims'/.test(registry)&&/'plugin_catalog_registered'=>true/.test(registry)],
