...
const checks=[
 ...
 ['Campaigns & Rewards V1 fulfills the reference contract',/'implementation_status'=>'integrated-v1\.00'/.test(registry)&&/campaigns_v100/.test(registry)&&/'plugin_catalog_registered'=>true/.test(registry)],
