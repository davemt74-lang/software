...
const checks=[
 ...
 ['Campaigns & Rewards V1.19 fulfills the reference contract',/'implementation_status'=>'integrated-v1\.19'/.test(registry)&&/'merchant_accounts'/.test(registry)&&/'reward_issuances'/.test(registry)&&/'reward_claims'/.test(registry)&&/'campaign_automation_rules'/.test(registry)&&/'plugin_catalog_registered'=>true/.test(registry)],
