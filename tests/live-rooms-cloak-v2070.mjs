...
{const [major,minor]=manifest.version.split('.').map(Number);must(major>20||(major===20&&minor>=70),'Phase 8 Browser Companion version must remain v20.70+');}
...
{const [major,minor]=runtimeVersion.split('.').map(Number);must(major>20||(major===20&&minor>=70),'extension runtime must remain v20.70+');}
