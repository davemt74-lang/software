...
const checks=[
 ...
 ['Cognitive domain advances to V1.23 release lifecycle',
  (registry.includes("'implementation_status'=>'integrated-v1.23'")||registry.includes("'implementation_status'=>'integrated-v1.24'"))&&registry.includes("'campaign.journey_published'")&&registry.includes("'campaign.journey_version_started'")],
 ...
 ['production package advances to V1.23 and includes schema runtime release cron migration and builder',
  (packageFlow.includes('"Campaigns & Rewards V1.23"')||packageFlow.includes('"Campaigns & Rewards V1.24"'))&&packageFlow.includes('campaigns-rewards-schema-v123.php')&&packageFlow.includes('campaigns-rewards-v123.php')&&packageFlow.includes('cron/campaigns-rewards-v123.php')&&packageFlow.includes('upgrade-campaigns-rewards-v123.sql')&&packageFlow.includes('campaign-journey-builder-v123.js')],
