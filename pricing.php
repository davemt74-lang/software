...
<?php if($packages): ?>
  ...
  ?>
    <article class="vp3-plan<?= $default?' featured':'' ?>">
      ...
      <?php endif; ?>
      <a class="vp3-btn<?= $default?' primary':'' ?>" data-funnel-cta data-vp3-cta="pricing_plan" data-vp3-target="<?= e($funnelPath==='/signup.php'?'signup':'demo') ?>" href="<?= e($funnelUrl) ?>"><?= e($funnelLabel) ?></a>
      <?php if($features): ?><ul><?php foreach(array_slice($features,0,10) as $feature): ?><li><?= e((string)$feature) ?></li><?php endforeach; ?></ul><?php endif; ?>
    </article>
  <?php endforeach; ?>
  </div>
<?php else: ?>
  <div class="vp3-cta-box"><div><h2>Packages are being configured.</h2><p>Create your VP3 account to begin onboarding, or book a demo to discuss the right setup.</p></div><div><a class="vp3-btn primary" data-vp3-cta="pricing_empty_signup" data-vp3-target="signup" href="<?= e(vp3_funnel_url('/signup.php',['source'=>'pricing'])) ?>">Create account →</a> <a class="vp3-btn" data-vp3-cta="pricing_empty_demo" data-vp3-target="demo" href="<?= e(vp3_funnel_url('/book-demo.php',['source'=>'pricing'])) ?>">Book a demo</a></div></div>
<?php endif; ?>
</div></section>
...
<section class="vp3-section soft"><div class="vp3-wrap"><div class="vp3-cta-box"><div><h2>Not sure which package fits?</h2><p>Tell us how you work and we’ll map the right VP3 configuration.</p></div><a class="vp3-btn primary" data-vp3-cta="pricing_find_setup" data-vp3-target="demo" href="<?= e(vp3_funnel_url('/book-demo.php',['source'=>'pricing'])) ?>">Find my setup →</a></div></div></section>
</main>
