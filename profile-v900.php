...
if($commerceHtml!==''){
    ...
    if(str_contains($html,$marker))$html=str_replace($marker,$marker.$commerceHtml,$html,$count=1);
    else $html=str_replace('</main>',$commerceHtml.'</main>',$html,$count=1);
}
...
$html=str_replace('</head>',$css.'</head>',$html,$count=1);
echo $html;
