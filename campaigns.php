...
<h4>Decision preview</h4><label>CRM contact<?php if($simulationContacts):?><select name="contact_id"><?php foreach($simulationContacts as $contactId=>$label):?><option value="<?= (int)$contactId ?>"><?= e($label) ?> · #<?= (int)$contactId ?></option><?php endforeach;?></select><?php else:?><input type="number" min="1" name="contact_id" required></label><?php endif;?>
...
<label>Decision priority<input type="number" min="0" max="10000" name="decision_priority" value="<?= (int)($editMessageTemplate['decision_priority']??100) ?>"></label>
