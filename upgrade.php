...
function vp3_upgrade_complete(): bool
{
    return access_schema_ready()
        ...
        && homeserver_work_v230_schema_ready()
        ...
        && vp3_browser_research_schema_ready_v2230()
        && vp3_browser_transaction_schema_ready_v2240()
        ...
        && campaigns_rewards_journey_release_schema_ready_v123()
        && campaigns_rewards_journey_operations_schema_ready_v124()
        && campaigns_rewards_decision_schema_ready_v125()
        ...
        && vp3_cognitive_value_schema_ready_v2570()
        && vp3_cognitive_decision_schema_ready_v2580()
        ...
        && vp3_cognitive_attention_schema_ready_v2410()
        ...
        && client_release_risk_schema_ready_v140()
        && client_release_readiness_schema_ready_v150()
        && client_fleet_schema_ready_v160()
        && client_release_automation_schema_ready_v170()
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!verify_csrf()) {
        ...
        try {
            ...
            vp3_browser_transaction_ensure_schema_v2240();
            ...
            vp3_cognitive_value_ensure_schema_v2570($pdo);
            vp3_cognitive_decision_ensure_schema_v2580($pdo);
            ...
            homeserver_work_v230_ensure_schema($pdo);
