...
<main class="vp3-auth-shell">
  ...
  <section class="vp3-auth-form-side">
    <div class="vp3-auth-card">
      ...
      <?php else: ?>
        <p class="vp3-auth-intro">Run the current schema upgrade while preserving existing content and access. Existing accounts, package assignments, team memberships, Team membership history, token balances, music content and onboarding progress are preserved, along with existing add-on grants.</p>
