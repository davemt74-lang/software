...
function vp3_upgrade_complete(): bool
{
    return access_schema_ready()
        ...
        && vp3_annotated_schema_ready_v2100()
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!verify_csrf()) {
        ...
        try {
            ...
            vp3_annotated_ensure_schema_v2100();
