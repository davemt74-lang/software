...
function personal_knowledge_artist_listening_source(array $item): array
{
    ...
    if(!str_contains($content,'Source: Artist Listening')&&!str_contains($description,'Source: Artist Listening'))return ['is_source'=>false,'url'=>''];
    $sourceUrl='';
