...
const VP3_BILLING_SCHEMA_VERSION = 'stripe-billing-phase2-20260906';

function billing_schema_ready(?PDO $pdo=null): bool
{
    $pdo??=db();
    if(!$pdo)return false;
    foreach([
...
function billing_ensure_schema(?PDO $pdo=null): void
{
    $pdo??=db();
    ...
    $pdo->exec("CREATE TABLE IF NOT EXISTS billing_customers (
    ...
    $pdo->exec("CREATE TABLE IF NOT EXISTS billing_checkout_sessions (
      id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
      user_id INT UNSIGNED NOT NULL,
      plan_request_id BIGINT UNSIGNED NULL,
      package_id INT UNSIGNED NULL,
    ...
    $pdo->exec("CREATE TABLE IF NOT EXISTS billing_webhook_events (
      id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
      provider VARCHAR(20) NOT NULL DEFAULT 'stripe',
    ...
    $pdo->exec("CREATE TABLE IF NOT EXISTS billing_portal_configs (
      id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
      provider VARCHAR(20) NOT NULL DEFAULT 'stripe',
