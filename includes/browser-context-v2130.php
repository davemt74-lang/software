...
function vp3_browser_context_suggestions_v2130(array $session,array $context,array $relations): array
{
    ...
    if(isset($caps['knowledge.write']))$suggestions[]=['id'=>'add_research','kind'=>'agent_prompt','label'=>'Add to Research','prompt'=>'Review this page and recommend the best existing VP3 Research project. Return only a draft research note and the project choice for my approval.'];
    ...
    if(isset($caps['knowledge.write']))$suggestions[]=['id'=>'save_knowledge','kind'=>'agent_prompt','label'=>'Save to Knowledge','prompt'=>'Review this page and draft a proposed VP3 Knowledge entry for my approval. Return the proposed title, summary, and source only.'];
    if(isset($caps['task.propose']))$suggestions[]=['id'=>'create_task','kind'=>'agent_prompt','label'=>'Create task','prompt'=>'Review this page and draft a proposed task for my approval. Return the title, details, and due-date suggestion only.'];
