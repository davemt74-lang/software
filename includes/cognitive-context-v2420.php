...
{
    return [
        'live_session','continuity','supervision','autonomy','portfolio','forecast','optimization','resource_budget','replanning','conversation','current_priorities','active_objects',
...
function vp3_cognitive_context_section_weight_v2420(string $section,bool $historyIntent=false): float
{
    if($historyIntent){
        return match($section){
            'conversation'=>98.0,'durable_memory'=>96.0,'replanning'=>95.97,'resource_budget'=>95.95,'optimization'=>95.9,'forecast'=>95.8,'portfolio'=>95.7,'autonomy'=>95.5,'supervision'=>95.0,'continuity'=>94.0,'episodic_memory'=>92.0,
    ...
    return match($section){
        'live_session'=>96.0,'replanning'=>95.97,'resource_budget'=>95.95,'optimization'=>95.9,'forecast'=>95.8,'portfolio'=>95.7,'autonomy'=>95.5,'supervision'=>95.0,'continuity'=>94.0,'current_priorities'=>92.0,'conversation'=>90.0,
