...
function vp3_cognitive_campaigns_rewards_contract_v2600(): array
{
    return [
        ...
        'objects'=>[
            ...
            'reward_product','reward_issuance','reward_claim','claim_code','loyalty_account',
        ],
        ...
        'events'=>[
            ...
            'campaign.budget_threshold','campaign.inventory_risk','campaign.page_published',
        ...
        'event_classes'=>[
            ...
            'campaign.page_published'=>'completion','campaign.signup_started'=>'informational','campaign.signup_completed'=>'completion','campaign.contact_acquired'=>'outcome',
