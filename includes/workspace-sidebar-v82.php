...
?>
<script data-workspace-account-live-wiring>(function(){'use strict';function loadAccountAgentUi(){if(!document.querySelector('.account-canvas-content'))return;if(document.querySelector('[data-account-agent-settings-loader]'))return;var s=document.createElement('script');s.src=<?= json_encode(url('/account-agent-settings-loader-v236.js?v=account-light-shell-20260905-agent-compute-v023-20260908-agent-compute-v024-20260908-agent-compute-v026-scope-20260908-agent-compute-v027-acceptance-20260908'),JSON_UNESCAPED_SLASHES) ?>;s.dataset.accountAgentSettingsLoader='server';document.body.appendChild(s);}if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',loadAccountAgentUi,{once:true});else loadAccountAgentUi();})();</script>