...
function campaigns_rewards_release_readiness_v118(?PDO $pdo=null): array
{
    ...
    $checks=[
        ...
        'cognitive_domain'=>in_array(($domain['implementation_status']??''),['integrated-v1.18','integrated-v1.19','integrated-v1.20','integrated-v1.21','integrated-v1.22','integrated-v1.23','integrated-v1.24'],true),
