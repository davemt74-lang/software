...
function campaigns_rewards_campaign_type_catalog_v118(): array
{
    ...
    return [
        ...
        'contest_giveaway'=>$t('Contest / Giveaway','Acquisition','Public contest entry with CRM acquisition. Reward issuance is gated until the merchant verifies or selects the winning participant.','contest',true,'contest_entry','after_verification','optional','Enter giveaway',['name','email'],true,true,true,true,'winner_selected'),
