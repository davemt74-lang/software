...
function campaigns_rewards_release_readiness_v119(?PDO $pdo=null): array
{
    ...
    $checks=[
        ...
        'cognitive_domain'=>in_array(($domain['implementation_status']??''),['integrated-v1.19','integrated-v1.20','integrated-v1.21','integrated-v1.22','integrated-v1.23','integrated-v1.24','integrated-v1.25','integrated-v1.26'],true),
