...
require_once __DIR__.'/homeserver-scope-v026.php';
require_once __DIR__.'/homeserver-acceptance-v027.php';
...
require_once __DIR__.'/ai-usage-accounting-v032.php';
...
require_once __DIR__.'/agent-relationship-chat.php';
require_once __DIR__.'/agent-crm.php';
require_once __DIR__.'/agent-crm-chat.php';
require_once __DIR__.'/agent-operator-intelligence.php';
...
require_once __DIR__.'/agent-manifest.php';
...
vp3_agent_referral_request_boot();
