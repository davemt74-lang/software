...
function member_navigation_menu_links(?array $user = null): array
{
    ...
    if($accountAllowed&&function_exists('agent_paid_appointments_schema_ready_v800')&&agent_paid_appointments_schema_ready_v800())$add($links,'appointment_payments','Appointment Payments',url('/appointment-payments.php'),'agent');
