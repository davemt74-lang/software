...
<?php if($notice):?><div class="token-notice" role="status"><?= e($notice) ?></div><?php endif;?><?php if($errorNotice):?><div class="token-notice error" role="alert"><?= e($errorNotice) ?></div><?php endif;?>
