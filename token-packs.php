...
<section class="account-canvas-hero"><div><span>AI Capacity</span><h1>Add tokens when you need them.</h1><div class="account-canvas-meta"><span><?= e($package) ?></span><span>Token packs do not extend trials or change package entitlements.</span></div></div><div class="account-canvas-actions"><a class="account-shell-button" href="<?= e(url('/subscription.php')) ?>">Plan & Usage</a></div></section>
